package com.microsoft.tourgide.telangana.jogulamba;
...
public class Jogulamba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAdapter7 customAdapter=new CustomAdapter7(getApplicationContext(),IMAGES);
