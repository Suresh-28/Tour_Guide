package com.microsoft.tourgide.telangana.karimnagar;
...
public class Karimnagar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAdapter9 customAdapter=new CustomAdapter9(getApplicationContext(),IMAGES);
