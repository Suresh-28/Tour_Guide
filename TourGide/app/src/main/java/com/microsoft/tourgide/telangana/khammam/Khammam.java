package com.microsoft.tourgide.telangana.khammam;
...
public class Khammam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAdapter10 customAdapter=new CustomAdapter10(getApplicationContext(),IMAGES);
