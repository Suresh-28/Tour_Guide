...
public class HotelSankalp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_sankalp);
        ...
        back5.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(HotelSankalp.this, Hotelskawal.class);
                View sharedView= back5;
                String transitionNane=getString(R.string.pressed5);
                ActivityOptions transiction=ActivityOptions.makeSceneTransitionAnimation(HotelSankalp.this,sharedView,transitionNane);
        ...
        CustomAdapter321 customAdapter=new CustomAdapter321(getApplicationContext(),IMAGES);
