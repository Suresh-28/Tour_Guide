...
import com.microsoft.tourgide.telangana.peddapalli.places.BuuddistActivity;
import com.microsoft.tourgide.telangana.peddapalli.places.SabithamActivity;

public class Peddapalli extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peddapalli);
        ...
        CustomAdapter20 customAdapter=new CustomAdapter20(getApplicationContext(),IMAGES);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.yadadri:
                Intent intent1=new Intent(Peddapalli.this, BuuddistActivity.class);
                View sharedView= yadadri1;
                String transitionNane=getString(R.string.kawaliflipper);
                ActivityOptions transiction=ActivityOptions.makeSceneTransitionAnimation(Peddapalli.this,sharedView,transitionNane);
                startActivity(intent1,transiction.toBundle());
                break;
            case R.id.surendrapuri:
                Intent intent2=new Intent(Peddapalli.this, SabithamActivity.class);
                View sharedView0= surendrapuri1;
                String transitionNane0=getString(R.string.kawaliflipper);
                ActivityOptions transiction0=ActivityOptions.makeSceneTransitionAnimation(Peddapalli.this,sharedView0,transitionNane0);
                startActivity(intent2,transiction0.toBundle());
                break;

            case R.id.back2:
                Intent intent3=new Intent(Peddapalli.this, Telangana.class);

                View sharedView1= back2;
                String transitionNane1=getString(R.string.pressed2);
                ActivityOptions transiction1=ActivityOptions.makeSceneTransitionAnimation(Peddapalli.this,sharedView1,transitionNane1);
