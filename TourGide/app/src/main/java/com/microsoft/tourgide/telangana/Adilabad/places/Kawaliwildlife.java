...
public class Kawaliwildlife extends AppCompatActivity {
   ViewPager vp;
   ...
   AdapterViewFlipper adapterViewFlipper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kawaliwildlife);
        ...
        direction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String uri=String.format(Locale.ENGLISH,"http://maps.google.com/maps?q=loc:%f,%f",19.1188949,78.9989734);
        ...
        back3.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Kawaliwildlife.this, AdilabadActivity.class);
                View sharedView= back3;
                String transitionNane=getString(R.string.kawaliflipper);
                ActivityOptions transiction=ActivityOptions.makeSceneTransitionAnimation(Kawaliwildlife.this,sharedView,transitionNane);
        ...
        hotels.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Kawaliwildlife.this,Hotelskawal.class);
